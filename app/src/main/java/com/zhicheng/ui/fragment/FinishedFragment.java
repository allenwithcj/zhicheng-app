 ...
 * 已办结
 */
public class FinishedFragment extends BaseFragment implements OfficialView, SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void initRootView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mRootView = inflater.inflate(R.layout.activity_main_official_finished, container, false);
    }
