package com.zhicheng.download;


import com.zhicheng.api.common.service.DownService;
import com.zhicheng.download.DownLoadListener.DownloadInterceptor;
import com.zhicheng.download.exception.HttpTimeException;
import com.zhicheng.download.exception.RetryWhenNetworkException;
    ...
    public void startDown(DownInfo info) {
        ...
        if (downInfos.contains(info)) {
            ...
            Retrofit retrofit = new Retrofit.Builder()
                    ...
                    .build();
            httpService = retrofit.create(DownService.class);
