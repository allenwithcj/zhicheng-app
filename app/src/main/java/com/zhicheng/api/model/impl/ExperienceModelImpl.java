...
public class ExperienceModelImpl implements ExperienceModel {
    ...
    @Override
    public void UpThings(String GUID, String jFile, List<String> imgs, ApiCompleteListener listener) {
    ...
    @Override
    public void upExperience(int requestType,String j, ApiCompleteListener listener) {
        MainService mMainService = ServiceFactory.createService(URL.HOST_URL_SERVER_ZHICHENG, MainService.class);
        mMainService.UpThings(j)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Subscriber<Response<CommonResponse>>() {
                    @Override
    ...
    @Override
    public void queryExp(String json, ApiCompleteListener listener) {
        MainService mMainService = ServiceFactory.createService(URL.HOST_URL_SERVER_ZHICHENG, MainService.class);
        mMainService.queyExp(json)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Subscriber<Response<ExperienceResponse>>() {
                    @Override
                    public void onCompleted() {
                    ...
                    @Override
                    public void onNext(Response<ExperienceResponse> mExperienceResponse) {
                        if (mExperienceResponse.isSuccessful()) {
                            listener.onComplected(mExperienceResponse.body());
                        } else {
                            listener.onFailed(new BaseResponse(mExperienceResponse.code(), mExperienceResponse.message()));
                        }
                    }
                });
    }
    ...
    @Override
    public void queryExpDetail(String json, ApiCompleteListener listener) {
        MainService mMainService = ServiceFactory.createService(URL.HOST_URL_SERVER_ZHICHENG, MainService.class);
        mMainService.queyExpDetail(json)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Subscriber<Response<ExperienceDetailResponse>>() {
                    @Override
                    public void onCompleted() {
                    ...
                    @Override
                    public void onNext(Response<ExperienceDetailResponse> mExperienceDetailResponse) {
                        if (mExperienceDetailResponse.isSuccessful()) {
                            listener.onComplected(mExperienceDetailResponse.body());
                        } else {
                            listener.onFailed(new BaseResponse(mExperienceDetailResponse.code(), mExperienceDetailResponse.message()));
                        }
                    }
                });
    }
                    ...
                    public void onNext(Response<IneedResponse> ineedResponseResponse) {
                        if (ineedResponseResponse.isSuccessful()) {
                            if (ineedResponseResponse.body().getIq().getQuery().getErrorCode().equals("0")) {
                                ...
                                query.setTableName("");
                                query.setTableID("");
                                query.setWfInfoID(Constant.EXPSID);
                                query.setGrid("");
    ...
    private void formSendDoRequest(MainService s, String j, ApiCompleteListener listener) {
        s.expFormSendDoRequest(j)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Subscriber<Response<ExperienceCommonResponse>>() {
                    @Override
                    public void onCompleted() {
                    ...
                    @Override
                    public void onNext(Response<ExperienceCommonResponse> mExperienceCommonResponse) {
                        if (mExperienceCommonResponse.isSuccessful()) {
                            listener.onComplected(mExperienceCommonResponse.body());
                        } else {
                            listener.onFailed(new BaseResponse(mExperienceCommonResponse.code(), mExperienceCommonResponse.message()));
                        }
                    }
                });
    }
